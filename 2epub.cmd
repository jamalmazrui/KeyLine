...
set convert=!sourceExt:~1!2txt
set util=!kl!!convert!.cmd
if exist "!util!" call "!util!" "!source!" >nul
if exist "!target!" exit /b

if exist "!pandoc!" call "!kl!pandoc2txt.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!calibre!" call "!kl!calibre2txt.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!libre!" call "!kl!libre2txt.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!wdVert!" call "!kl!wd2txt.cmd" "!source!" >nul
