...
rem for some reason, pdf2html.cmd does not handle file name with & character
rem if "!sourceExt!"==".pdf" echo "!kl!pdf2html.cmd" "!source!" >nul
if "!sourceExt!"==".pdf" call :pdf2html "!source!"
if exist "!target!" "!utf8b!" "!target!" >nul & exit /b

set convert=!sourceExt:~1!2html
set util=!kl!!convert!.cmd
rem echo util=!util!
if exist "!util!" call "!util!" "!source!" >nul
if exist "!target!" "!utf8b!" "!target!" >nul & exit /b

if exist "!wdVert!" call "!kl!wd2html.cmd" "!source!" >nul
if exist "!target!" "!utf8b!" "!target!" >nul & exit /b

if exist "!calibre!" (if exist "!pandoc!" call "!kl!calibre_pandoc2html.cmd" "!source!" >nul)
if exist "!target!" "!utf8b!" "!target!" >nul & exit /b

if exist "!pandoc!" call "!kl!pandoc2html.cmd" "!source!" >nul
if exist "!target!" "!utf8b!" "!target!" >nul & exit /b

if exist "!libre!" call "!kl!libre2html.cmd" "!source!" >nul
