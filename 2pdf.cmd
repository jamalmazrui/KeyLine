...
if "!sourceExt!"==".ppt" call "!kl!pp2pdf.cmd" "!source!" >nul
if exist "!target!" exit /b
if "!sourceExt!"==".ppt" echo Error & exit /b

if "!sourceExt!"==".pptx" call "!kl!pp2pdf.cmd" "!source!" >nul
if exist "!target!" exit /b
if "!sourceExt!"==".pptx" echo Error & exit /b

if "!sourceExt!"==".xls" call "!kl!xl2pdf.cmd" "!source!" >nul
if exist "!target!" exit /b
if "!sourceExt!"==".xls" echo Error & exit /b

if "!sourceExt!"==".xlsx" call "!kl!xl2pdf.cmd" "!source!" >nul
if exist "!target!" exit /b
if "!sourceExt!"==".xlsx" echo Error & exit /b

if exist "!wdVert!" call "!kl!wd2pdf.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!calibre!" call "!kl!calibre2pdf.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!libre!" call "!kl!libre2pdf.cmd" "!source!" >nul
if exist "!target!" exit /b
