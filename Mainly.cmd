...
rem echo sourceExt=!sourceExt!
rem echo targetExt=!targetExt!
rem if not "!sourceExt!"=="!targetExt!" (echo no) else echo Yes
if not "!sourceExt!"=="!targetExt!" (if exist "!target!" exit /b)
echo !sourceBase!
