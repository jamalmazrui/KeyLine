...
rem "!pandoc!" -s --quiet "!source!"  -o "!target!"
"!pandoc!" --toc -s -f markdown --lua-filter "!settings!\pagebreak.lua" --reference-doc "!settings!\PythonTemplate.docx" --quiet "!source!"  -o "!target!"
