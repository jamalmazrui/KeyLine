...
rem "!ff!" -i "!source!" -overwrite-original_in_place -q -metadata !metaname!="!metavalue!" "!source!" >nul
if exist "!mid!" del "!mid!"
"!ff!" -i "!source!" -metadata !metaname!="!metavalue!" "!mid!" >nul
move /y "!mid!" "!source!" >null
