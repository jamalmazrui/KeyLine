...
if exist "!calibre!" (if exist "!wdVert!" call "!kl!calibre_wd2html.cmd" "!source!" >nul)
if exist "!target!" (pushd "!temp!" & "!kl!pandoc2htm.cmd" "!target!" >nul & move /y "!targetBase!" "!sourceDir!" >nul & popdir)
if exist "!target!" exit /b
