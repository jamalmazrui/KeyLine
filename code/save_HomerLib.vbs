...
Public Function Iif(iCondition, v1, v2)
...
Public Function DialogConfirm(sTitle, sMessage, sDefault)
...
Public Function DialogInput(sTitle, sField, sValue)
...
Public Function DialogShow(oTitle, oText)
Dim iFlags
Dim sTitle, sText
...
Public Function DialogShowType(sExp)
