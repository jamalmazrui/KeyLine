...
if "!sourceExt!"==".md" set targetExt=.docx
...
rem if "!sourceExt!"==".md""!pandoc!" -s -f markdown --lua-filter "!settings!\pagebreak.lua" --reference-doc "!settings!\PythonTemplate.docx" --quiet "!source!"  -o "!target!"
cd "!targetDir!"
if "!sourceExt!"==".md" call "!md2docx!" "!source!" >nul
