...
if exist "!calibre!" call "!kl!calibre2epub.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!pandoc!" call "!kl!pandoc2epub.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!libre!" call "!kl!libre2epub.cmd" "!source!" >nul
if exist "!target!" exit /b

if exist "!wdVert!" call "!kl!wd2epub.cmd" "!source!" >nul
