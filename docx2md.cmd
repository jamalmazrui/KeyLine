...
rem allow grid tables when Pandoc cannot create a pipe table from more complex content
rem "!pandoc!" -s -f "docx+styles" -t "markdown-simple_tables-multiline_tables-grid_tables" --wrap=none --markdown-headings=atx --quiet "!source!"  -o "!target!"
rem "!pandoc!" -s -f "docx+styles" -t "markdown-simple_tables-multiline_tables" --wrap=none --markdown-headings=atx --quiet "!source!"  -o "!target!"
"!pandoc!" -s -f "docx+styles" -t "markdown-simple_tables-multiline_tables" --wrap=none --track-changes=all --markdown-headings=atx --quiet "!source!"  -o "!target!"
